   	 	...
   	 	<div class="col_3">
					<?php 
						if(isset($_GET["img_error"])){
						 echo "<h1 class='alert alert-danger'>Please Choose Image</h1>";
						} 
			        ?>
   	        <div class="col-sm-4 row_2">
				 <img src="profile/<?php echo $r["code"];?>.jpg" width="100%"><br><br>
				  <form method="post" action="updateimage.php" enctype="multipart/form-data">
					<label>Change Image</label>
					<input type="file" name="pic"  ><br>
					<input type="submit" value="Modify Image" class="btn btn-danger">
				 </form>
			</div>
				...
				<table class="table_working_hours">
		        	<tbody>
						...
						<tr class="opened">
				         ...
				         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  <a href="myprofile.php"><button class="btn btn-danger">Full Details</button></a> 
