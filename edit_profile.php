   	 ...
   	 <div class="col-md-8 profile_left">
   	 	...
   	 	<div class="col_3">
   	        <div class="col-sm-4 row_2">
				 <div class="col-sm-4 row_2">
				 <img src="profile/<?php echo $r["code"];?>.jpg" width="400%"><br><br>
				...
				<table class="table_working_hours">
		        	<tbody>
		        		<tr class="opened_1">
							...
							<td class="day_value"><input type="text" name="fname" value="<?php echo $r["fname"];?>" class="form-control"></td>
						</tr>
					    <tr class="opened">
							<td class="day_label">Last Name :</td>
							<td class="day_value"><input type="text" name="lname" value="<?php echo $r["lname"];?>" class="form-control"></td>
						</tr>
					    <tr class="opened">
							<td class="day_label">Date of Birth :</td>
							<td class="day_value"><input type="date" name="dob" value="<?php echo $r["dob"];?>" class="form-control"></td>
						</tr> 
					    <tr class="opened">
							<td class="day_label">Marital Status :</td>
							<td class="day_value">
								<select name="mstatus" class="form-control">
									<option value="<?php echo $r["mstatus"];?>" ><?php echo $r["mstatus"];?></option>
						...
						<tr class="opened">
							...
							<select name="occupation" class="form-control">
								<option value="<?php echo $r["occupation"];?>" ><?php echo $r["occupation"];?></option>
							...
							<div class="form-group">
								<table width=100%> 
										 <td>
										   <label class="day_label">Gender</label>
										 </td> 
										 <td align="left">
