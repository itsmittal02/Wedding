...
$(document).ready(function(){
	...
	$("#submit").click(function(){
		...
		//alert(fname+" "+lname+" "+rel);
		 $.post(
		        "update.php",{fname:fname,lname:lname,dob:dob,gender:gender,caste:caste,religion:religion},function(data){
					if(data=="success"){
						$("#alert-msg").attr("class","alert alert-success");
						$("#alert-msg").fadeIn(1000);
						$("#alert-msg").html("Record Updated");
					}
					else{
	...
	$("input").keyup(function(){
		...
		var rec=$(this).val();
		$.post(
		      "update_record.php",{field:field,rec:rec},function(data){ });
	});
  ...
  <div class="container">
   ...
   <div class="profile">
   	 <div class="col-md-8 profile_left">
   	 	<h2>Profile Id: </h2> &nbsp; <h2><?php echo $r["code"]?></h2>
   	 	<div class="col_3">
   	          <div class="col-sm-4 row_2">
	     <div class="col-sm-6">
				<div class="img-responsive" alt=""></div>
					 <img src="profile/<?php echo $r["code"]?>.jpg" class="img-responsive" / >  
				  </div>
				  </div>
			<div class="col-sm-8 row_1">
			               <div class="alert alert-danger" id="alert-msg"></div>
									  
			 
				<table class="table_working_hours">
		        	<tbody>
					<td class="day_label">First Name :</td>
							<td class="day_value"><input type="text" class="form-control" id="fname" value="<?php echo $r["fname"]; ?>"></td>
						</tr>
						<tr class="opened_1">
							<td class="day_label">Last Name :</td>
							<td class="day_value"><input type="text" class="form-control" id="lname" value="<?php echo $r["lname"]; ?>"></td>
						</tr>
					 
					    <tr class="opened">
							<td class="day_label">Date Of Birth :</td>
							<td class="day_value"><input type="date" class="form-control"id="dob" value="<?php echo $r["dob"]; ?>"></td>
						</tr>
						 
					    <tr class="opened">
							<td class="day_label">Gender :</td>
							<td class="day_value"><select id="gender" class="form-control">
					    ...
					    <tr class="closed">
							...
							<td class="day_value closed"><select id="caste" class="form-control">
					    ...
					    <tr class="closed">
							...
							<td class="day_value closed"><select id="religion" class="form-control">
