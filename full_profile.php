...
<?php
	if(!isset($_COOKIE["login"])){
		...
		if(!isset($_GET["code"])){
			...
			include("db.php");
			$rs=mysqli_query($conn,"select * from user where code='$code'");
   	 ...
   	 <div class="col-md-8 profile_left">
   	 	...
   	 	<div class="col_3">
   	        <div class="col-sm-4 row_2">
				 <img src="profile/<?php echo $code;?>.jpg" width="100%">
			</div>
				...
				<table class="table_working_hours">
		        	<tbody>
						...
						<tr class="opened">
				         ...
				         <div class="day_label">Message :</div>
								 <form method="post" action="message.php?code=<?php echo $r["code"];?>">
									<textarea name="msg" rows=3 cols=50 style="resize:none"></textarea><br>
