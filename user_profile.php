<?php
       if(!isset($_COOKIE["login"])){
	        header("location:login.php");
			 ...
			 $rs=mysqli_query($conn,"select * from project where code='$user_code'");
  ...
  <div class="container">
   ...
   <div class="profile">
   	 <div class="col-md-8 profile_left">
   	 	<h2>Profile Id : <?php echo $r["code"]?></h2>
   	 	<div class="col_3">
   	        <div class="col-sm-4 row_2">
				<!--<div class="flexslider">
					 <ul class="slides">
						 <li data-thumb="profile/<?php echo $r["code"]?>.jpg">-->
	...
	<div class="view_profile" style="background-image:url(images/wall.jpg);height:auto">
		     <table class="table table-borderless w3-card">
				...
				<tr><td align="center"><a href="user_profile.php?id=<?php echo $usr["code"];?>" style="cursor:pointer"><?php echo $usr["fname"]." ".$usr["lname"];?></strong></td>
			     <td><h5><a href="user_profile.php?id=<?php echo $usr["code"];?>" style="cursor:pointer"><button class="btn btn-danger">View  Profile</button></a></h5></td></tr>
			 </table>
