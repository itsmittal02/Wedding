				        		 ...
				        		 <?php
									...
									<?php
								      if(isset($_GET["missmatch"])){
										?>
										<div class="alert alert-danger"><h3>Password MissMatch</h3></div>
									<?php
									}
									?>
									 ...
									 <?php
								       if(isset($_GET["invalid"])){
										?>
										<div class="alert alert-danger"><h3>Invalid Current Password</h3></div>
									<?php
									}
									?>
									<form method = "post" action = "update_password.php">
									<label>Current Password :</label>
									 <input type ="password" name = "cp" class = "form-control" placeholder = "Current-password" /><br><br>
								 
							     
									<label>New Password :</label>
									 <input type ="password" name = "np"  class = "form-control" placeholder = "New-password" /><br><br>
								 
							     
									<label>Retype Password :</label>
									 <input type ="password" name = "rp"  class = "form-control" placeholder = "Retype-password" /><br><br>
