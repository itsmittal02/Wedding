...
<div class="grid_3">
  <div class="container">
   ...
   if(isset($_GET["success"])){
	   ?>
   <div class="alert alert-success"><h3>Registration Successfully Please Login</h3></div>
   <?php
   }
    if(isset($_GET["empty"])){
	   ?>
   <div class="alert alert-info"><h3>All Field Required</h3></div>
   <?php
   }
    if(isset($_GET["again"])){
	   ?>
   ...
   ?>
	     ...
	     <form method="post" action="registration.php" enctype="multipart/form-data">
			...
			<div class="form-group">
		      ...
		      <input type="date" class="form-control" name="dob" class="form-text required">
		    </div> <br>
			<div class="form-group">
			    <table width=100%>
					   <tr>
			...
			<div class="form-group">
		      <label for="edit-name">Religion <span class="form-required" title="This field is required.">*</span></label>
		       <select name="religion" class="form-control">
					...
					<option value="Ishaai">Ishaai</option>
			...
			<div class="form-group">
		      <label for="edit-name">State <span class="form-required" title="This field is required.">*</span></label>
					...
					<div class="form-group">
		              <label for="inputDistrict">District <span class="form-required" title="This field is required.">*</span></label>
					...
					<div class="form-group">
					  <label for="edit-name">MotherTongue <span class="form-required" title="This field is required.">*</span></label>
					...
					<div class="form-group">
		              <label>Profile Image <span class="form-required" title="This field is required.">*</span></label>
